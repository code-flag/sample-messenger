 ...
 * @param {*} io - socket io
 */
export const staffController = (staffNsp: Namespace, socket: Socket, staffId: any, residentNsp: Namespace, io: any) => {
    ...
    socket.on("staff-send-message", (data: any) => {
    ...
    socket.on("staff-message-recieve", (data: any) => {
